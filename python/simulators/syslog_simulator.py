...
class SyslogSimulator:
    ...
    def _create_devices(self, device_config: Dict[str, Any]) -> Dict[str, NetworkDevice]:
        ...
        if not device_config:
            device_config = {
                'rr-01': {'role': 'rr', 'ip': '10.0.0.1', 'interfaces': ['GigabitEthernet0/0/1', 'GigabitEthernet0/0/2']},
                'rr-02': {'role': 'rr', 'ip': '10.0.0.2', 'interfaces': ['GigabitEthernet0/0/1', 'GigabitEthernet0/0/2']},
                'spine-01': {'role': 'spine', 'ip': '10.0.1.1', 'interfaces': ['GigabitEthernet0/0/1', 'GigabitEthernet0/0/2', 'GigabitEthernet0/0/3']},
                'spine-02': {'role': 'spine', 'ip': '10.0.1.2', 'interfaces': ['GigabitEthernet0/0/1', 'GigabitEthernet0/0/2', 'GigabitEthernet0/0/3']},
                'tor-01': {'role': 'tor', 'ip': '10.0.2.1', 'interfaces': ['GigabitEthernet0/0/1', 'GigabitEthernet0/0/2', 'GigabitEthernet0/0/3', 'GigabitEthernet0/0/4']},
                'tor-02': {'role': 'tor', 'ip': '10.0.2.2', 'interfaces': ['GigabitEthernet0/0/1', 'GigabitEthernet0/0/2', 'GigabitEthernet0/0/3', 'GigabitEthernet0/0/4']},
                'edge-01': {'role': 'edge', 'ip': '10.0.3.1', 'interfaces': ['GigabitEthernet0/0/1', 'GigabitEthernet0/0/2']},
                'edge-02': {'role': 'edge', 'ip': '10.0.3.2', 'interfaces': ['GigabitEthernet0/0/1', 'GigabitEthernet0/0/2']},
            }
    ...
    async def simulate_correlated_failure(
        ...
        syslog_msg = self.generate_syslog_message(
            affected_device, 
            scenario,
            neighbor_ip=peer_ip
        )
...
async def main():
    ...
    config = {
        ...
        'devices': {
            'rr-01': {'role': 'rr', 'ip': '10.0.0.1', 'interfaces': ['GigabitEthernet0/0/1', 'GigabitEthernet0/0/2']},
            'spine-01': {'role': 'spine', 'ip': '10.0.1.1', 'interfaces': ['GigabitEthernet0/0/1', 'GigabitEthernet0/0/2']},
            'tor-01': {'role': 'tor', 'ip': '10.0.2.1', 'interfaces': ['GigabitEthernet0/0/1', 'GigabitEthernet0/0/2']},
            'edge-01': {'role': 'edge', 'ip': '10.0.3.1', 'interfaces': ['GigabitEthernet0/0/1', 'GigabitEthernet0/0/2']},
        }
    }
