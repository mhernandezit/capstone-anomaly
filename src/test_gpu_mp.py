...
def benchmark_gpu_vs_cpu():
    ...
    gpu_detector = create_gpu_mp_detector(window_bins=64, gpu_memory_limit="2GB")
    ...
    cpu_detector = create_gpu_mp_detector(window_bins=64, gpu_memory_limit="0MB")  # Force CPU
