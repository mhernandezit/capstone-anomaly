...
class MLPipelineIntegration:
    ...
    def _generate_alert_title(self, ml_result: Dict[str, Any]) -> str:
        ...
        detected_series = ml_result.get("detected_series", [])
        # impact = ml_result.get('impact_analysis', {})  # Unused variable
    ...
    async def run_integrated_cycle(self):
        ...
        try:
            ...
            await self.generate_alert_if_needed(ml_result)

            # Log results
            if ml_result["is_anomaly"]:
                logger.info(
                    f"Anomaly detected: confidence={ml_result['anomaly_confidence']:.2f}, "
    ...
    def get_integration_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "detection_rate": self.stats["anomalies_detected"]
            / max(self.stats["features_processed"], 1),
