"""
NATS Message Bus Publisher for Network Telemetry
...
class MessageBusManager:
    """
    Manages the message bus for network telemetry.
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "publish_rate": (
                self.stats["messages_published"] / elapsed_time if elapsed_time > 0 else 0
            ),
