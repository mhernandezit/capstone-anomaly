    ...
    def __init__(self, config_path: str = None):
        ...
        self.demo_scenarios = [
            ...
            },
            {
                ...
                'expected_signals': ['SNMP memory metrics', 'BGP convergence delays', 'System logs'],
            ...
            },
            {
                ...
                'expected_signals': ['Power metrics', 'Multiple device correlation', 'Environmental alerts'],
                'detection_time': '2-3 minutes'
            }
        ]
...
async def main():
    ...
    parser.add_argument(
        "--demo-mode", 
        action="store_true",
        help="Run in demonstration mode with detailed output"
    )
    parser.add_argument(
        "--config",
        type=str,
